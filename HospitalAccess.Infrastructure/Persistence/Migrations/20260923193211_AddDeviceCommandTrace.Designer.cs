...
namespace HospitalAccess.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923193211_AddDeviceCommandTrace")]
    partial class AddDeviceCommandTrace
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalAccess.Domain.Entities.Controller", b =>
                {
                    ...
                    b.Property<string>("TvIpAddress")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<DateTime?>("TvLastSeenUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("TvPort")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(5555);
            ...
            modelBuilder.Entity("HospitalAccess.Domain.Entities.DeviceCommandTrace", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ControllerId", "StartedAtUtc");

                    b.ToTable("DeviceCommandTraces");
                });
            ...
            modelBuilder.Entity("HospitalAccess.Domain.Entities.SystemSettings", b =>
                {
                    ...
                    b.Property<int?>("BackupMaxFiles")
                        .HasColumnType("integer");

                    b.Property<int>("BedStayHistoryRetentionDays")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("DeviceTraceEnabled")
                        .HasColumnType("boolean");

                    b.Property<int>("DeviceTraceRetentionDays")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("HomeAssistantExtraActionLabel")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("HomeAssistantExtraActionService")
                        .IsRequired()
                        .HasColumnType("text");
